cellranger-7.2.0/cellranger count --id=mapping_6_1_scRNAseq_25E \
                   --transcriptome=../data/custom_genome/dm6.46_27_enhancers_feb2024/index/ \
                   --fastqs=../data/scRNA-seq_sequencing_output/scRNA-seq/Lib6_1 \
...
cellranger-7.2.0/cellranger count --id=mapping_6_2_scRNAseq_25E \
                   --transcriptome=../data/custom_genome/dm6.46_27_enhancers_feb2024/index/ \
                   --fastqs=../data/scRNA-seq_sequencing_output/scRNA-seq/Lib6_2 \
...
cellranger-7.2.0/cellranger count --id=mapping_6_3_scRNAseq_25E \
                   --transcriptome=../data/custom_genome/dm6.46_27_enhancers_feb2024/index/ \
                   --fastqs=../data/scRNA-seq_sequencing_output/scRNA-seq/Lib6_3 \
